...
tests/CMakeFiles/test_tables.dir/test_tables.c.o: tests/test_tables.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/rabbitmq-c/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/CMakeFiles/test_tables.dir/test_tables.c.o"
	cd /rabbitmq-c/tests && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test_tables.dir/test_tables.c.o   -c /rabbitmq-c/tests/test_tables.c
...
tests/CMakeFiles/test_tables.dir/test_tables.c.i: cmake_force
	...
	cd /rabbitmq-c/tests && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /rabbitmq-c/tests/test_tables.c > CMakeFiles/test_tables.dir/test_tables.c.i
...
tests/CMakeFiles/test_tables.dir/test_tables.c.s: cmake_force
	...
	cd /rabbitmq-c/tests && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /rabbitmq-c/tests/test_tables.c -o CMakeFiles/test_tables.dir/test_tables.c.s
...
tests/test_tables: tests/CMakeFiles/test_tables.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/rabbitmq-c/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable test_tables"
	cd /rabbitmq-c/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test_tables.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test_tables.dir/clean:
	cd /rabbitmq-c/tests && $(CMAKE_COMMAND) -P CMakeFiles/test_tables.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test_tables.dir/clean

tests/CMakeFiles/test_tables.dir/depend:
	cd /rabbitmq-c && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /rabbitmq-c /rabbitmq-c/tests /rabbitmq-c /rabbitmq-c/tests /rabbitmq-c/tests/CMakeFiles/test_tables.dir/DependInfo.cmake --color=$(COLOR)
